...
import static base.baseUtil.userFullName;
import static org.junit.Assert.assertTrue;

public class tests {
    private base.baseUtil baseUtil;

    public tests(baseUtil util) {
        this.baseUtil = util;
    }
    ...
    public void setup() {
        System.setProperty("webdriver.chrome.driver",
                "//Users//faruksevil//Desktop//cucumber//cucumber//src//test//driver//chromedriver");
...
*/
    ...
    public void i_enter_valid_credentials(String username, String password, String userFullName) {
        ...
        base.baseUtil.userFullName = userFullName;
    ...
    public void i_should_be_taken_to_the_Overview_page() throws Exception {
        ...
        assertTrue(actualuserFullName, actualuserFullName.contains(userFullName));
